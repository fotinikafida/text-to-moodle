...
+ Φάσεις κατασκευής σεναρίου. Σειριακό και ριζωματικό σενάριο (moodle book)-επιλέξτε την επικαιροποιημένη έκδοση που αναρτάται εδώ. 
+ Διδακτική εφαρμογή και αποτελέσματα των Νέων ΠΣ στη σχολική δράση (moodle activity lesson,μικρομάθημα τύπου σεναρίου διακλάδωσης)-επιλέξτε την επικαιροποιημένη έκδοση που αναρτάται εδώ.
