...
* Ενα «διαδραστικό βιβλίο» εργαλείο Moodle, html εγχειρίδιο που περιέχει κείμενο, εικόνες και animations, και που ονομάζεται ***'Σύνταξη γραμμικών vs ριζωματικών σεναρίων μάθησης'***
 **Μαθησιακός στόχος:** *οι εκπαιδευτικοί να μπορούν να:* 
